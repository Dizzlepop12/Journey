...
public class BlockFrozenPortal extends BlockBreakable {
	...
	public boolean makePortal(World worldIn, BlockPos p_176548_2_) {
		BlockFrozenPortal.Size size = new BlockFrozenPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
		if (size.func_150860_b() && size.field_150864_e == 0) {
			size.func_150859_c();
			return true;
		} else {
			BlockFrozenPortal.Size size1 = new BlockFrozenPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
	...
	public static class Size
	{
		...
		protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
		{
			...
			for (i = 0; i < 22; ++i)
			{
				...
				if (!this.func_150857_a(this.field_150867_a.getBlockState(blockpos1).getBlock()) || this.field_150867_a.getBlockState(blockpos1.down()).getBlock() != JourneyBlocks.frozenPortalFrame)
				{
					break;
				}
			}
			...
			return block == JourneyBlocks.frozenPortalFrame ? i : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					for (i = 0; i < this.field_150868_h; ++i)
					{
						...
						if (block == JourneyBlocks.frozenPortal)
						{
							++this.field_150864_e;
						}
						...
						if (i == 0)
						{
							...
							if (block != JourneyBlocks.frozenPortalFrame)
							{
								break label56;
							}
						}
			...
			for (i = 0; i < this.field_150868_h; ++i)
			{
				if (this.field_150867_a.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != JourneyBlocks.frozenPortalFrame)
				{
		...
		{
			return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == JourneyBlocks.fire || p_150857_1_ == JourneyBlocks.frozenPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				{
					this.field_150867_a.setBlockState(blockpos.up(j), JourneyBlocks.frozenPortal.getDefaultState().withProperty(BlockFrozenPortal.field_176550_a, this.field_150865_b), 2);
				}
			}
		}
	}
