	...
	public static class Size
	{
		...
		protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
		{
			...
			for (i = 0; i < 22; ++i)
			{
				...
				if (!this.func_150857_a(this.field_150867_a.getBlockState(blockpos1).getBlock()) || this.field_150867_a.getBlockState(blockpos1.down()).getBlock() != JourneyBlocks.depthsPortalFrame)
				{
					break;
				}
			}
			...
			return block == JourneyBlocks.depthsPortalFrame ? i : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					for (i = 0; i < this.field_150868_h; ++i)
					{
						...
						if (block == JourneyBlocks.depthsPortal)
						{
							++this.field_150864_e;
						}
						...
						if (i == 0)
						{
							...
							if (block != JourneyBlocks.depthsPortalFrame)
							{
								break label56;
							}
						}
			...
			for (i = 0; i < this.field_150868_h; ++i)
			{
				if (this.field_150867_a.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != JourneyBlocks.depthsPortalFrame)
				{
		...
		{
			return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == JourneyBlocks.fire || p_150857_1_ == JourneyBlocks.depthsPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				{
					this.field_150867_a.setBlockState(blockpos.up(j), JourneyBlocks.depthsPortal.getDefaultState().withProperty(BlockDepthsPortal.field_176550_a, this.field_150865_b), 2);
				}
			}
		}
	}
