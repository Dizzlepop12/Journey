	...
	public static class Size
	{
		...
		protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
		{
			...
			for (i = 0; i < 22; ++i)
			{
				...
				if (!this.func_150857_a(this.field_150867_a.getBlockState(blockpos1).getBlock()) || this.field_150867_a.getBlockState(blockpos1.down()).getBlock() != JourneyBlocks.boilPortalFrame)
				{
					break;
				}
			}
		...
		protected int func_150858_a()
		{
			...
			for (i = 0; i < this.field_150868_h; ++i)
			{
				if (this.field_150867_a.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != JourneyBlocks.boilPortalFrame)
				{
		...
		{
			return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == JourneyBlocks.fire || p_150857_1_ == JourneyBlocks.boilPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				{
					this.field_150867_a.setBlockState(blockpos.up(j), JourneyBlocks.boilPortal.getDefaultState().withProperty(BlockBoilPortal.field_176550_a, this.field_150865_b), 2);
				}
			}
		}
	}
