...
public class EntityFlamingArrow extends EntityArrow implements IProjectile {
	...
	public EntityFlamingArrow(World worldIn, double d, double d1, double d2) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityFlamingArrow(World worldIn, EntityLivingBase e, EntityLivingBase eb, float f, float f1) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityFlamingArrow(World worldIn, EntityLivingBase e, float f) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = e;
