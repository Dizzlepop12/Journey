/** 					if(movingobjectposition.entityHit instanceof EntityLivingBase && !(movingobjectposition.entityHit instanceof EntityEnderman) && movingobjectposition.entityHit != shootingEntity) {
						...
						float hearts = e.getHealth();
						if((hearts >= 1.0F) & (hearts < 20.0F)){
							e.setHealth(hearts + 1.0F);
						}
					} */
...
public class EntityHealthArrow extends EntityArrow implements IProjectile {
	...
	public EntityHealthArrow(World worldIn) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityHealthArrow(World worldIn, double d, double d1, double d2) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityHealthArrow(World worldIn, EntityLivingBase e, EntityLivingBase eb, float f, float f1) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityHealthArrow(World worldIn, EntityLivingBase e, float f) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = e;
