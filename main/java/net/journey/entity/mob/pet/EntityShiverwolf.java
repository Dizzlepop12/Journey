...
public class EntityShiverwolf extends EntityModTameable
{
    ...
    {
        EntityShiverwolf entitywolf = new EntityShiverwolf(this.worldObj);
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityShiverwolf)
            {
                EntityShiverwolf entitywolf = (EntityShiverwolf)p_142018_1_;
	...
	public String setLivingSound() {
		return EnumSounds.EMPTY.getNonPrefixedName();
	}
