...
public class EntitySkyEel extends EntityModFlying {

	public EntitySkyEel(World par1World) {
		super(par1World);
		this.moveHelper = new EntitySkyEel.MoveHelper();
		this.tasks.addTask(5, new EntitySkyEel.AIRandomFly());
		this.tasks.addTask(7, new EntitySkyEel.AIFireballAttack());
        this.tasks.addTask(7, new EntitySkyEel.AILookAround());
	...
	protected void dropFewItems(boolean b, int j) {
		...
		if(rand.nextInt(1) == 0) dropItem(JourneyItems.fluffyFeather, 4);
		super.dropFewItems(b, j);
		if(rand.nextInt(30) == 0) dropItem(JourneyItems.cloudiaOrb, 2);
		super.dropFewItems(b, j);
		if(rand.nextInt(60) == 0) dropItem(JourneyItems.cloudiaOrb, 4);
		super.dropFewItems(b, j);
	}
	...
	private class AIRandomFly extends EntityAIBase {
		private EntitySkyEel e = EntitySkyEel.this;
	...
	public class AIFireballAttack extends EntityAIBase {
		private EntitySkyEel entity = EntitySkyEel.this;
		public int counter;
