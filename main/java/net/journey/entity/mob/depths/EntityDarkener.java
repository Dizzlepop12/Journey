...
public class EntityDarkener extends EntityModFlying {

	public EntityDarkener(World par1World) {
		super(par1World);
		this.moveHelper = new EntityDarkener.MoveHelper();
		this.tasks.addTask(5, new EntityDarkener.AIRandomFly());
		this.tasks.addTask(7, new EntityDarkener.AIFireballAttack());
        this.tasks.addTask(7, new EntityDarkener.AILookAround());
	...
	private class AIRandomFly extends EntityAIBase {
		private EntityDarkener e = EntityDarkener.this;
	...
	public class AIFireballAttack extends EntityAIBase {
		private EntityDarkener entity = EntityDarkener.this;
		public int counter;
