 ...
 * Author ~ Ryan Bakody (Dizzlepop12)
 */
    ...
    public class EntityDarkfish extends EntityModFlying {
    	...
    	public EntityDarkfish(World par1World) {
    		super(par1World);
    		this.moveHelper = new EntityDarkfish.MoveHelper();
    		this.tasks.addTask(5, new EntityDarkfish.AIRandomFly());
    		this.tasks.addTask(7, new EntityDarkfish.AIFireballAttack());
            this.tasks.addTask(7, new EntityDarkfish.AILookAround());
    	...
    	private class AIRandomFly extends EntityAIBase {
    		private EntityDarkfish e = EntityDarkfish.this;
    	...
    	public class AIFireballAttack extends EntityAIBase {
    		private EntityDarkfish entity = EntityDarkfish.this;
    		public int counter;
