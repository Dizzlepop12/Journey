...
public class EntityObserver extends EntityModMob {
	...
	protected void dropFewItems(boolean b, int j) {
		if(rand.nextInt(10) == 0) dropItem(JourneyItems.hellcrustIngot, 3);
		super.dropFewItems(b, j);
		if(rand.nextInt(5) == 0) dropItem(JourneyItems.hellcrustIngot, 2);
		super.dropFewItems(b, j);
	    if(rand.nextInt(3) == 0) dropItem(JourneyItems.boilPowder, 8);
		super.dropFewItems(b, j);
