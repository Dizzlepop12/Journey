...
public class EntityOverseerElder extends EntityModFlying {
	...
	public EntityOverseerElder(World par1World) {
		super(par1World);
		this.moveHelper = new EntityOverseerElder.MoveHelper();
		this.tasks.addTask(5, new EntityOverseerElder.AIRandomFly());
		this.tasks.addTask(7, new EntityOverseerElder.AIFireballAttack());
        this.tasks.addTask(7, new EntityOverseerElder.AILookAround());
	...
	protected void dropFewItems(boolean b, int j) {
		...
		if(rand.nextInt(5) == 0) dropItem(JourneyItems.collectorRock, 2);
		super.dropFewItems(b, j);
		if(rand.nextInt(10) == 0) dropItem(JourneyItems.collectorRock, 4);
		super.dropFewItems(b, j);
		if(rand.nextInt(50) == 0) dropItem(JourneyItems.overseeingTablet, 1);
		super.dropFewItems(b, j);
	}
	...
	public class AIFireballAttack extends EntityAIBase {
		private EntityOverseerElder entity = EntityOverseerElder.this;
		public int counter;
