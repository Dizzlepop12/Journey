...
public class EntitySurfaceSeer extends EntityModFlying {

	public EntitySurfaceSeer(World par1World) {
		super(par1World);
		this.moveHelper = new EntitySurfaceSeer.MoveHelper();
		this.tasks.addTask(5, new EntitySurfaceSeer.AIRandomFly());
		this.tasks.addTask(7, new EntitySurfaceSeer.AIFireballAttack());
        this.tasks.addTask(7, new EntitySurfaceSeer.AILookAround());
	...
	public class AIFireballAttack extends EntityAIBase {
		private EntitySurfaceSeer entity = EntitySurfaceSeer.this;
		public int counter;
