...
public class JourneyBook {
    ...
    public static void registerTests(int amountOfBooks) {
        for (int i = 0; i < amountOfBooks; i++)
            journeyBook(new Book(), "Journey Guide" + i);
    }

    public static void journeyBook(Book book, String title) {
        PageText page1 = new PageText("ewwew");
        ...
        pages.add(page1);
        pages.add(page2);
        pages.addAll(PageHelper.pagesForLongText("wwewewRY LONG FOR NOTHING MATE", new ItemStack(Items.diamond)));
        pages.add(page3);
        pages.add(page4);
        pages.add(page5);
        pages.add(page6);
