...
public class ModelWoodCreature extends ModelBase {
	...
	public ModelWoodCreature() {
	    ...
	    textureHeight = 32;
	      ...
	      arm1 = new ModelRenderer(this, 40, 20);
	      arm1.addBox(-1F, 0F, -2F, 4, 8, 4);
	      arm1.setRotationPoint(4F, 16F, 0F);
	      arm1.setTextureSize(64, 32);
	      arm1.mirror = true;
	      setRotation(arm1, 0F, 0F, 0F);
	      arm2 = new ModelRenderer(this, 40, 20);
	      arm2.addBox(-3F, 0F, -2F, 4, 8, 4);
	      arm2.setRotationPoint(-4F, 16F, 0F);
	      arm2.setTextureSize(64, 32);
	      arm2.mirror = true;
	      setRotation(arm2, 0F, 0F, 0F);
	      arm3 = new ModelRenderer(this, 40, 20);
	      arm3.addBox(-2F, 0F, -2F, 4, 8, 4);
	      arm3.setRotationPoint(0F, 16F, 4F);
	      arm3.setTextureSize(64, 32);
	      arm3.mirror = true;
	      setRotation(arm3, 0F, 0F, 0F);
	      arm4 = new ModelRenderer(this, 40, 20);
	      arm4.addBox(-2F, 0F, -3F, 4, 8, 4);
	      arm4.setRotationPoint(0F, 16F, -4F);
	      ...
	      head0 = new ModelRenderer(this, 32, 0);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		...
		this.head3.rotateAngleY = f1 / (180F / (float)Math.PI);
		this.head3.rotateAngleX = f1 / (180F / (float)Math.PI);
