    ...
    public static class AmbientMobFactory implements IParticleFactory
        {
            ...
            {
                EntityFX entityfx = new EntitySummoningFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
    ...
    public static class Factory implements IParticleFactory
        {
            public EntityFX getEntityFX(int particleID, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, int... p_178902_15_)
            {
                return new EntitySummoningFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            }
        }
    ...
    public static class InstantFactory implements IParticleFactory
        {
            ...
            {
                EntityFX entityfx = new EntitySummoningFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
                ((EntitySummoningFX)entityfx).setBaseSpellTextureIndex(144);
                return entityfx;
            }
        }
