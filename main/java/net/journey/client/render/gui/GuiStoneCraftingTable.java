...
public class GuiStoneCraftingTable extends GuiContainer
{
    ...
    {
        this.fontRendererObj.drawString(I18n.format("container.crafting"), 28, 6, 421000);
        this.fontRendererObj.drawString(I18n.format("container.inventory"), 8, this.ySize - 96 + 2, 421000);
    }
