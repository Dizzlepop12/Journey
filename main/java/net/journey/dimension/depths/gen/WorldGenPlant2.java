...
public class WorldGenPlant2 extends WorldGenAbstractTree {
	...
	public WorldGenPlant2(boolean var1) {
		this(var1, rand.nextInt(10) + 10, 0, 0);
	}

	public WorldGenPlant2(boolean var1, int var2, int var3, int var4) {
		super(var1);
	...
	public boolean generate(World world, Random r, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 0, j + 6, k + 0), JourneyBlocks.darkbloomTop.getDefaultState());
