...
public class WorldGenIceTree2 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 1, j + 7, k + 1), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 1, j + 7, k + 2), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 1, j + 7, k + 3), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 1, j + 8, k + 2), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 1, j + 10, k + 2), JourneyBlocks.iceLeaves.getDefaultState());
		...
		world.setBlockState(new BlockPos(i + 2, j + 7, k + 0), JourneyBlocks.iceLeaves.getDefaultState());
		...
		world.setBlockState(new BlockPos(i + 2, j + 7, k + 4), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 8, k + 1), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 8, k + 2), JourneyBlocks.iceLog.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 8, k + 3), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 9, k + 2), JourneyBlocks.iceLog.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 10, k + 1), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 10, k + 2), JourneyBlocks.iceLog.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 10, k + 3), JourneyBlocks.iceLeaves.getDefaultState());
		world.setBlockState(new BlockPos(i + 2, j + 11, k + 2), JourneyBlocks.iceLeaves.getDefaultState());
