...
public class WorldGenLamp2 extends WorldGenerator {
	...
	public boolean generate(World world, Random r, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 0, j + 3, k + 1), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 0, j + 3, k + 2), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		...
		world.setBlockState(new BlockPos(i + 1, j + 3, k + 0), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 1, j + 3, k + 1), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 1, j + 3, k + 2), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 2, j + 0, k + 1), JourneyBlocks.workshopStone.getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 2, j + 3, k + 0), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 2, j + 3, k + 1), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		world.setBlockState(new BlockPos(i + 2, j + 3, k + 2), JourneyBlocks.frozenLamp.getDefaultState(), 2);
		return true;
	}
}