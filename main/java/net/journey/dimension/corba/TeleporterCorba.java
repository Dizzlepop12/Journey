...
public class TeleporterCorba extends Teleporter {
	...
	public TeleporterCorba(WorldServer var1) {
		super(var1);
		this.myWorld = var1;
	}
	...
	public boolean isBlockPortal(World var1, int var2, int var3, int var4) {
		return var1.getBlockState(new BlockPos(var2, var3, var4)) == JourneyBlocks.corbaPortal.getDefaultState();
	}
	...
	private void makePortalAt(World world, int x, int y, int z) {
		...
		world.setBlockState(new BlockPos(x + 3, y, z), JourneyBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z + 1), JourneyBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z + 1), JourneyBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z + 1), JourneyBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z + 2), JourneyBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z + 2), JourneyBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z + 2), JourneyBlocks.corbaPortal.getDefaultState());
	}
}
