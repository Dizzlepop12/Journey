...
public class TeleporterSenterian extends Teleporter {
	...
	private void makePortalAt(World world, int x, int y, int z) {
		y = 90;
		world.setBlockState(new BlockPos(x, y, z), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x, y, z + 1), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x, y, z + 2), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z + 3), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z + 3), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z + 3), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z + 1), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z + 2), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z - 1), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z - 1), JourneyBlocks.senterianPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z - 1), JourneyBlocks.senterianPortalFrame.getDefaultState());
