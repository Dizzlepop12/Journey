...
public class WorldGenStarlightTree extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		int i = pos.getX(), j = pos.getY(), k = pos.getZ();
			...
			world.setBlockState(new BlockPos(i + 0, j + 2, k + 1), JourneyBlocks.cloudiaDirt.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 3, k + 1), JourneyBlocks.cloudiaGrass.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 7, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 7, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 7, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 8, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 8, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 8, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 9, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 9, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 9, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			...
			world.setBlockState(new BlockPos(i + 1, j + 7, k + 0), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 7, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 7, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 7, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 7, k + 4), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 8, k + 0), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 8, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 8, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 8, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 8, k + 4), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 9, k + 0), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 9, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 9, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 9, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 9, k + 4), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 10, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 10, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 1, j + 10, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			...
			world.setBlockState(new BlockPos(i + 2, j + 10, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 2, j + 10, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			...
			world.setBlockState(new BlockPos(i + 3, j + 7, k + 0), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 7, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 7, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 7, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 7, k + 4), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 8, k + 0), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 8, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 8, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 8, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 8, k + 4), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 9, k + 0), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 9, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 9, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 9, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 9, k + 4), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 10, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 10, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 3, j + 10, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			...
			world.setBlockState(new BlockPos(i + 4, j + 7, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 7, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 7, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 8, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 8, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 8, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 9, k + 1), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 9, k + 2), JourneyBlocks.cloudiaLeaves.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 9, k + 3), JourneyBlocks.cloudiaLeaves.getDefaultState());
