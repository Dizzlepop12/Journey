...
public class TeleporterWither extends Teleporter {
	...
	public boolean isBlockPortal(World var1, int var2, int var3, int var4) {
		return var1.getBlockState(new BlockPos(var2, var3, var4)) == JourneyBlocks.witherPortal.getDefaultState();
	}
	...
	private void makePortalAt(World world, int x, int y, int z) {
		...
		world.setBlockState(new BlockPos(x + 1, y, z + 3), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z + 3), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z + 3), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z + 1), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z + 2), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z - 1), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z - 1), JourneyBlocks.witherPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z - 1), JourneyBlocks.witherPortalFrame.getDefaultState());

		world.setBlockState(new BlockPos(x + 1, y, z), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 2, y, z), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 3, y, z), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 1, y, z + 1), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 2, y, z + 1), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 3, y, z + 1), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 1, y, z + 2), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 2, y, z + 2), JourneyBlocks.witherPortal.getStateFromMeta(5));
		world.setBlockState(new BlockPos(x + 3, y, z + 2), JourneyBlocks.witherPortal.getStateFromMeta(5));
	}
}
