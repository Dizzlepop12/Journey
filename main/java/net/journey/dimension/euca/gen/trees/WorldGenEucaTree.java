...
public class WorldGenEucaTree extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 1, j + 0, k + 9), leaves);
		world.setBlockState(new BlockPos(i + 1, j + 1, k + 5), leaves);
		...
		world.setBlockState(new BlockPos(i + 2, j + 0, k + 9), leaves);
		...
		world.setBlockState(new BlockPos(i + 4, j + 1, k + 8), leaves);
		...
		world.setBlockState(new BlockPos(i + 5, j + 1, k + 1), leaves);
		...
		world.setBlockState(new BlockPos(i + 5, j + 1, k + 8), leaves);
		world.setBlockState(new BlockPos(i + 5, j + 1, k + 9), leaves);
		...
		world.setBlockState(new BlockPos(i + 6, j + 1, k + 8), leaves);
		...
		world.setBlockState(new BlockPos(i + 8, j + 0, k + 9), leaves);
		world.setBlockState(new BlockPos(i + 8, j + 1, k + 4), leaves);
		world.setBlockState(new BlockPos(i + 8, j + 1, k + 5), leaves);
		world.setBlockState(new BlockPos(i + 8, j + 1, k + 6), leaves);
		world.setBlockState(new BlockPos(i + 9, j + 0, k + 1), leaves);
		world.setBlockState(new BlockPos(i + 9, j + 0, k + 2), leaves);
		...
		world.setBlockState(new BlockPos(i + 9, j + 0, k + 8), leaves);
		world.setBlockState(new BlockPos(i + 9, j + 0, k + 9), leaves);
		world.setBlockState(new BlockPos(i + 9, j + 1, k + 5), leaves);
